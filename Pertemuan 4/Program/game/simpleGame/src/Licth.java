public class Licth extends Role implements Character{
    ...
    public Licth(String eNama, int eDefensePoint, int eAttackPoint, int eWeaponPower, int eEquipmentPower, int eManaPoint) {

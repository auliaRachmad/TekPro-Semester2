public class Archer extends Role implements Character{
    ...
    public Archer(String eNama, int eDefensePoint, int eAttackPoint, int eWeaponPower, int eEquipmentPower, int eSkillPoint) {
    ...
    public int powerTotal() {
        return ((defensePoint*hitPoint) + (attackPoint*hitPoint) + weaponPower + equipmentPower)+(skillPoint*hitPoint);
    }

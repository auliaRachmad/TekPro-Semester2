public class DemonLord extends Role implements Character{
    ...
    public DemonLord(String eNama, int eDefensePoint, int eAttackPoint, int eWeaponPower, int eEquipmentPower, int eSkillPoint) {

public class Goblin extends Role implements Character{
    ...
    public Goblin(String eNama, int eDefensePoint, int eAttackPoint, int eWeaponPower, int eEquipmentPower, int eSpeedPoint) {
